...
public class Degree {
	 ...
	 * "To get a degree you need high school diploma". Class 'Degree' has 2
	 * subclasses namely 'Bachelors' and Masters’. In Masters class override method
...
class Masters extends Degree
{
	void getPrerequisite()
	{
		System.out.println("To get a MS degree you need a bachelors diploma!");
	}
}
